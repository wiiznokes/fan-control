...
pub struct ContextMenuOverlay<'a, Message, Renderer = iced::Renderer>
where
    Message: 'a + Clone,
...
impl<'a, Message, Renderer> Overlay<Message, Renderer> for ContextMenuOverlay<'a, Message, Renderer>
where
    Message: 'a + Clone,
    Renderer: 'a + renderer::Renderer,
    Renderer::Theme: StyleSheet,
